...
pre { font-family: 'Fira Code', monospace; font-size: 0.71rem; line-height: 1.2; background: #0f172a; color: #f8fafc; padding: 6px 8px; border-radius: 4px; margin: 2px 0; overflow-x: auto; }
...
@media print {
  ...
  /* PRINT FRIENDLY LIGHT CODE BLOCK BACKGROUND */
  pre {
...
<!-- PAGE 1: FOUNDATION & PROBLEM 1 (LC 208) -->
<div class="page">
<div class="ph">
  <div><h1>TRIE DATA STRUCTURE</h1><div class="sub">FAANG Master Guide — Foundation &amp; Problem 1</div></div>
  <div style="text-align:right"><div class="pn">PAGE 1 OF 7</div><div class="ptag">PREFIX TREE · O(L) SEARCH · LC 208</div></div>
</div>
...
<div class="g2" style="margin-bottom:8px">
  <div class="box pur">
    ...
    <div class="bc">
      ...
      <div class="aha" style="margin-top:4px">
        ...
        Instead of searching N words in O(N × L) time, a Trie shares common prefix nodes! Search time is strictly <strong>O(L)</strong> (L = word length), independent of dictionary size N!
      </div>
    </div>
  </div>
  ...
  <div class="box sky">
    ...
    <div class="bc">
      <ul style="padding-left:12px;font-size:0.76rem">
...
<!-- PAGE 2: PROBLEMS 2 & 3 (LC 14 & LC 648) -->
<div class="page">
<div class="ph">
  <div><h1>TRIE DATA STRUCTURE</h1><div class="sub">Core Patterns — Longest Prefix &amp; Shortest Root</div></div>
  <div style="text-align:right"><div class="pn">PAGE 2 OF 7</div><div class="ptag">LC 14 · LC 648 · PREFIX MATCHING</div></div>
</div>
...
<div class="prow">
  ...
  <div class="prow-body">
    <div class="pc" style="flex:1">
      <div class="pc-head">Problem Statement &amp; Mechanics</div>
      <div style="font-size:0.76rem;margin-bottom:4px">
        Given a dictionary of root words and a sentence, replace every word in the sentence with the shortest root that matches its prefix. If no root matches, keep the original word.
      </div>
      <div class="io-box">
...
<!-- PAGE 3: PROBLEMS 4 & 5 (LC 211 & LC 1268) -->
<div class="page">
<div class="ph">
  <div><h1>TRIE DATA STRUCTURE</h1><div class="sub">Core Patterns — Wildcard Search &amp; Autocomplete</div></div>
  <div style="text-align:right"><div class="pn">PAGE 3 OF 7</div><div class="ptag">LC 211 · LC 1268 · AUTOCOMPLETE</div></div>
</div>
...
<!-- PAGE 4: PROBLEMS 6 & 7 (LC 677 & LC 212) -->
<div class="page">
<div class="ph">
  <div><h1>TRIE DATA STRUCTURE</h1><div class="sub">Core Patterns — Map Sum Pairs &amp; Grid DFS Pruning</div></div>
  <div style="text-align:right"><div class="pn">PAGE 4 OF 7</div><div class="ptag">LC 677 · LC 212 · GRID DFS</div></div>
</div>
...
<!-- PAGE 5: PROBLEMS 8 & 9 (LC 421 & LC 336) -->
<div class="page">
<div class="ph">
  <div><h1>TRIE DATA STRUCTURE</h1><div class="sub">Advanced Patterns — Bitwise Binary Trie &amp; Palindrome Pairs</div></div>
  <div style="text-align:right"><div class="pn">PAGE 5 OF 7</div><div class="ptag">LC 421 · LC 336 · BITWISE XOR</div></div>
</div>
...
<!-- PAGE 6: PROBLEM 10 (LC 1032) & DECISION TREE -->
<div class="page">
<div class="ph">
  <div><h1>TRIE DATA STRUCTURE</h1><div class="sub">Advanced Patterns — Stream Trie &amp; Decision Tree</div></div>
  <div style="text-align:right"><div class="pn">PAGE 6 OF 7</div><div class="ptag">LC 1032 · STREAM TRIE · DECISION TREE</div></div>
</div>
...
<!-- PAGE 7: SUMMARY TABLE & INTERVIEW CHEAT SHEET -->
<div class="page">
<div class="ph">
  <div><h1>TRIE DATA STRUCTURE</h1><div class="sub">Complete 10 Problems Summary &amp; Interview Cheat Sheet</div></div>
  <div style="text-align:right"><div class="pn">PAGE 7 OF 7</div><div class="ptag">SUMMARY · CHEAT SHEET · RULES</div></div>
</div>

<div class="box grn" style="margin-bottom:8px">
...
<div class="g2" style="margin-bottom:8px">
  <div class="box sky">
    ...
    <div class="bc">
      <ul style="padding-left:14px;font-size:0.78rem">
        ...
        <li><strong>Leaf Storage:</strong> Store full word string directly in leaf nodes (<code>node.word = word</code>) during Word Search II (LC 212) to avoid string reconstruction!</li>
...
print("Saved Spacious 10-Problem Trie HTML to", dst_html)

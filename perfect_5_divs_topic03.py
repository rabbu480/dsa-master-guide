...
print("Raw page blocks count:", len(raw_pages))

# Group raw 10 pages into 5 pairs:
# New Page 1 = Old 1 + Old 2
# New Page 2 = Old 3 + Old 4
# New Page 3 = Old 5 + Old 6
# New Page 4 = Old 7 + Old 8
# New Page 5 = Old 9 + Old 10
...
for idx, pair in enumerate(grouped_pairs):
    combined = ""
    for inner_idx, p in enumerate(pair):
...
print("=== PERFECTLY CONSOLIDATED TOPIC 03 INTO 5 TOP-LEVEL PAGE DIVS ===")

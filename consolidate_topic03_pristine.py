...
print("Original Topic03 page count:", len(raw_pages))

# We want 5 pages! Let's group the 10 raw pages into 5 pairs:
# New Page 1 = Old Page 1 + Old Page 2
# New Page 2 = Old Page 3 + Old Page 4
# New Page 3 = Old Page 5 + Old Page 6
# New Page 4 = Old Page 7 + Old Page 8
# New Page 5 = Old Page 9 + Old Page 10
...
new_pages = []
for idx, pair in enumerate(grouped_pairs):
    combined = ""
    for inner_i, p in enumerate(pair):
...
print("=== SUCCESSFULLY CONSOLIDATED TOPIC 03 INTO 5 DENSE A4 PAGES ===")

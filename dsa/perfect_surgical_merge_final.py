...
# Exact boundary string replacements for 2, 4, 6, 8:
b2 = """</div>
...
# Replace page headers of pages 2, 4, 6, 8, 10
ph2 = """<div class="ph">
...
text = text.replace(b10, '')

text = text.replace(ph2, '')
text = text.replace(ph4, '')
text = text.replace(ph6, '')
text = text.replace(ph8, '')
text = text.replace(ph10, '')
...
print("=== PERFECT SURGICAL MERGE WITHOUT LEAVING PH HEADERS ===")

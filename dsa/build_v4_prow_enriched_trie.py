  ...
  <div class="box pur">
    ...
    <div class="bc">
      ...
      <div class="aha" style="margin-top:4px">
        ...
        Instead of searching N words in O(N × L) time, a Trie shares common prefix nodes! Search time is strictly <strong>O(L)</strong> (L = length of word), independent of dictionary size N!
      </div>
    </div>
  </div>
...
<div class="prow">
  <div class="prow-head">
    <div class="ptag2">FOUNDATION</div>
    <div class="ptitle">STANDARD IMPLEMENT TRIE CLASS (LC 208)</div>
    <div class="psub">e.g. Implement Trie (Prefix Tree)</div>
  </div>
  <div class="prow-body">
    <div class="pc" style="flex:1">
      <div class="pc-head">Problem Statement &amp; Mechanics</div>
      <div style="font-size:0.76rem;margin-bottom:4px">
        Implement a Trie with <code>insert(word)</code>, <code>search(word)</code>, and <code>startsWith(prefix)</code> methods.
      </div>
      <div class="io-box">
      ...
      <div class="dry-box">
        ...
        1. <code>insert("apple")</code>: Root $\rightarrow$ 'a' $\rightarrow$ 'p' $\rightarrow$ 'p' $\rightarrow$ 'l' $\rightarrow$ 'e' (Mark <code>isEnd = true</code> at 'e').<br/>
        ...
        4. <code>insert("app")</code>: Traverse 'a'$\rightarrow$'p'$\rightarrow$'p', set <code>isEnd = true</code> at 2nd 'p'.<br/>
        5. <code>search("app")</code>: Traverse 'a'$\rightarrow$'p'$\rightarrow$'p'. <code>isEnd == true</code> $\rightarrow$ Return <strong>true</strong>.
      </div>
    </div>
    <div class="pc" style="flex:1.4">
      <div class="pc-head">Template — LC 208</div>
<pre>class Trie {
...
<div class="prow">
  <div class="prow-head">
    ...
    <div class="ptitle">SHORTEST ROOT PREFIX REPLACEMENT (LC 648)</div>
  ...
  <div class="prow-body">
    <div class="pc" style="flex:1">
      ...
      <div class="dry-box">
        ...
        5. Result: <code>"the cat was rat by the bat"</code>.
      </div>
    </div>
    <div class="pc" style="flex:1.4">
      <div class="pc-head">Template — LC 648</div>
...
<div class="prow">
  <div class="prow-head">
    ...
    <div class="ptitle">ADD AND SEARCH WORDS WITH WILDCARD '.' (LC 211)</div>
  ...
  <div class="prow-body">
    ...
    <div class="pc" style="flex:1.4">
      <div class="pc-head">Template — LC 211</div>
...
<div class="prow">
  <div class="prow-head">
    ...
    <div class="ptitle">AUTOCOMPLETE SEARCH SUGGESTIONS (LC 1268)</div>
  ...
  <div class="prow-body">
    ...
    <div class="pc" style="flex:1.4">
      <div class="pc-head">Template — LC 1268</div>
...
<div class="prow">
  <div class="prow-head">
    ...
    <div class="ptitle">WORD SEARCH II (Trie + 2D Grid DFS Pruning) (LC 212)</div>
  ...
  <div class="prow-body">
    ...
    <div class="pc" style="flex:1.4">
      <div class="pc-head">Template — LC 212</div>
...
<div class="prow">
  <div class="prow-head">
    <div class="ptag2">PATTERN 5</div>
    <div class="ptitle">BITWISE 31-BIT BINARY TRIE (Maximum XOR Pair) (LC 421)</div>
    <div class="psub">e.g. Maximum XOR of Two Numbers in an Array</div>
  </div>
  <div class="prow-body">
    <div class="pc" style="flex:1">
      <div class="pc-head">Problem Statement &amp; Mechanics</div>
    ...
    <div class="pc" style="flex:1.4">
      <div class="pc-head">Template — LC 421</div>
...
<div class="box amb" style="margin-top:4px">
...
<div class="box red">
  ...
  <div class="bc">
    <ol style="padding-left:16px;font-size:0.78rem">
      ...
      <li><strong>Combine with DFS for Grids:</strong> For Boggle / Word Search II, build Trie from dictionary words first, then DFS grid while walking Trie pointers simultaneously!</li>
      <li><strong>Bitwise XOR Signal:</strong> For <em>"maximum XOR pair"</em>, use a 31-bit Binary Trie!</li>
      <li><strong>Time Complexity Clarity:</strong> In interviews, state L = max word length, N = number of words. Trie ops are $O(L)$, NOT $O(N)$!</li>
    </ol>
  </div>
</div>
</div>

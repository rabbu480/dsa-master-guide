...
<div class="ph">
  ...
  <div style="text-align:right"><div class="pn">PAGE 2 OF 5</div><div class="ptag">LC 125 · LC 167 · LC 15</div></div>
</div>

<div class="prob-card">
  <div class="prob-header">
    <div class="prob-title">1. VALID PALINDROME — LC 125</div>
    <div class="prob-badge">CONVERGING SCAN</div>
  </div>
  <div class="prob-body">
    <div style="font-weight:700;color:var(--sub)">Problem Statement:</div>
    <div>Check if a string is a palindrome after converting all uppercase letters to lowercase and removing non-alphanumeric characters.</div>
    <div class="io-box">
...
<div class="prob-card">
  <div class="prob-header">
    <div class="prob-title">2. 3SUM (ZERO SUM TRIPLETS) — LC 15</div>
    <div class="prob-badge">SORT + 2-POINTER LOOP</div>
  </div>
  <div class="prob-body">
    <div style="font-weight:700;color:var(--sub)">Problem Statement:</div>
    <div>Given an integer array nums, return all unique triplets <code>[nums[i], nums[j], nums[k]]</code> such that <code>nums[i] + nums[j] + nums[k] == 0</code>.</div>
    <div class="io-box">
    ...
    <div class="dry-box">
      ...
      2. Fix <code>i=0 (-4)</code>: Target pair sum = +4. Two pointers <code>l=1(-1), r=5(2)</code>. Max possible sum = 1 < 4 $\rightarrow$ no match.<br/>
      3. Fix <code>i=1 (-1)</code>: Target pair sum = +1. <code>l=2(-1), r=5(2)`: sum = 1 == target! Found `[-1, -1, 2]`. Skip duplicates!<br/>
      4. `l=3(0), r=4(1)`: sum = 1 == target! Found `[-1, 0, 1]`.
    </div>
...
<div class="prob-card">
  <div class="prob-header">
    <div class="prob-title">3. CONTAINER WITH MOST WATER — LC 11</div>
    <div class="prob-badge">BOUNDARY GREEDY</div>
  </div>
  <div class="prob-body">
    <div style="font-weight:700;color:var(--sub)">Problem Statement:</div>
    <div>Given n non-negative integers representing vertical lines, find two lines that together with the x-axis form a container containing the most water.</div>
    <div class="io-box">
      <strong>Input:</strong> height = [1,8,6,2,5,4,8,3,7]<br/>
      <strong>Output:</strong> 49 (Between index 1 (height 8) and index 8 (height 7): width=7, minHeight=7 $\rightarrow$ Area = 49)
    </div>
    <div class="dry-box">
      <strong>🔍 Step-by-Step Manual Dry Run:</strong><br/>
      1. Start <code>l=0 (h=1)</code>, <code>r=8 (h=7)</code>: Area = $\min(1,7) \times 8 = 8$. Since $h[l] < h[r]$, moving $r$ inward CANNOT increase area (height limited by $h[l]=1$). Must move <code>l++</code>!<br/>
      2. <code>l=1 (h=8)</code>, <code>r=8 (h=7)</code>: Area = $\min(8,7) \times 7 = 49$. Max Area updated to <strong>49</strong>. Move shorter side <code>r--</code>!
    </div>
...
<div class="prob-card">
  <div class="prob-header">
    <div class="prob-title">4. TRAPPING RAIN WATER — LC 42</div>
    <div class="prob-badge">HARD · 2 POINTER BOUNDARY</div>
  </div>
  <div class="prob-body">
    <div style="font-weight:700;color:var(--sub)">Problem Statement:</div>
    <div>Given n non-negative integers representing an elevation map where width of each bar is 1, compute how much water it can trap after raining.</div>
    <div class="io-box">
    ...
    <div class="dry-box">
      <strong>🔍 Step-by-Step Manual Dry Run:</strong><br/>
      1. Water trapped at cell $i$ is determined by $\min(\text{leftMax}, \text{rightMax}) - h[i]$.<br/>
      2. Maintain <code>leftMax</code> and <code>rightMax</code>. If <code>leftMax < rightMax</code>, water at <code>left</code> is strictly bounded by <code>leftMax</code>! Process <code>left++</code>.<br/>
      3. Otherwise, process <code>right--</code>. Total space complexity is <strong>$O(1)$</strong> (vs $O(N)$ DP array)!
    </div>
...
<div class="g2" style="margin-bottom:8px">
  <div class="box sky">
    ...
    <div class="bc">
      ...
      Therefore, any container with $l$ fixed and $r' < r$ MUST have area $\le$ current area! Thus, we can safely discard pointer $l$!
    </div>
  </div>
  ...
  <div class="box amb">
    ...
    <div class="bc">
      <ul style="padding-left:12px;font-size:0.75rem">
        ...
        <li><strong>Pointer Crossover:</strong> Loop condition must be <code>while (l < r)</code> (or <code>l <= r</code> for binary search).</li>
      </ul>
    </div>
  </div>
</div>
